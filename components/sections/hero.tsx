...
export function Hero() {
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-aws-blue via-aws-blue-dark to-slate-900">
      {/* Background Pattern */}
